...
/*	.main {
	...
	<div class="sidenav" id="appsidenav" >
	<a href="welcome.php"><img id="flogos" src="../imgs/starw.png" alt="Short Term Appointment Register"></a>
		
		<a href="../applicant/welcome.php">Home</a>		
		<button class="dropdown-btn">Account Information  
		...
		<a href="../applicant/qualification.php">Qualifications</a>
		<a href="../applicant/experience.php">Experience</a>
		<a href="../applicant/skill.php">Skills</a>
		<a href="../applicant/reference.php">References</a>
		...
		<a href="../applicant/logout.php">Logout
