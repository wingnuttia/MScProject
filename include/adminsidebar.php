...
<style>
	...
	<a href="../admin/welcome.php"><img id="flogos" src="../imgs/starw.png" alt="Short Term Appointment Register"></a>
		...
		<div class="dropdown-container">
			...
			<a href="#">Assign Additional User Types</a>
			<a href="#">View All Internal Users</a>
			<a href="#">View All External Users</a>
		</div>
		...
		<button class="dropdown-btn">Positions 
			<i class="fa fa-caret-down"></i>
			</button>
				<div class="dropdown-container">
					<a href="../admin/LivePositions.php">Live Positions</a>
					<a href="../admin/ArchivePositions.php">Archieved Positions</a>
					<a href="../admin/AssignedPositions.php">Assigned Positions</a>
				</div>
