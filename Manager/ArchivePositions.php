...
require ('../include/staffSession.php');
	...
	$readposts="SELECT p.PostID, p.StaffID, p.RoleID, p.PostTitle, p.SchoolID, p.DepartmentID, p.HoursTypeID, p.EstStartDate, p.EstEndDate, p.Description, p.live, p.assigned, r.RoleID, r.Role, r.active, s.SID, s.School, d.DID, d.Department, d.SID, ht.TypeID, ht.HoursType, su.UserID
	...
	WHERE su.UserID= '$userid' AND p.live= '0'
