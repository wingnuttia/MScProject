...
require ('../include/appSession.php');
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST') {
		...
		$readmemskill = "SELECT ID,  AppID, SkillID FROM SkillSetMem WHERE SkillSetMem.ID = '$deletesid';";
			...
			<div class="row">
				...
				<div class="column content">
					<div class="column middle">
								...
								<?php while($row = $resultskill1->fetch_assoc()){
									...
									<tbody>
										<tr>
											<td>$cat1</td>
											<td>$skill1</td>
											<td><a href='deleteskill.php' class='btn btn-danger' name='Sdelete' title='Delete'><i class='fa fa-trash'></i></a></td>
										</tr>
										<input type='hidden' value='$getsid' name='postid'>
									</tbody>";
								}
							?>
							</table>
						...
						<div class="col-md-6">
						<?php
							$readskill2="SELECT al.ApplicantID, al.userName,  sc.SkillCatID, sc.Category, sc.active, o.AppID, o.OtherSkill, o.catID
						...
						<?php while($row = $resultskill2->fetch_assoc()){
							...
							<tbody>
								<tr>
									<td>$cat2</td>
									<td>$otherskill</td>
									<td><a href='deleteoskill.php' class='btn btn-danger' title='Delete'><i class='fa fa-trash'></i></a></td>
								</tr><input type='hidden' value='$getoid' name='postid'>
							</tbody>";
						}
					?>
					</table>
						...
						<div class="row">
							<div class="text-right col-md-12">
								<a href="reference.php" class='btn btn-danger'title="Next">Reference<i class="fa fa-chevron-right"></i></a>	
							</div>
						</div>
</div>						
						</br>
